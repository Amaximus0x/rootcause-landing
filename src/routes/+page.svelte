...
<div class="w-full h-auto bg-pure-white overflow-hidden relative">
      ...
      <!-- Video container -->
			<div class="relative mb-16 lg:mb-[250px]">
				...
				<div class="absolute top-[24px] left-1/2 transform -translate-x-1/2 w-[350px] h-[205px] lg:w-[973px] lg:h-[563px] rounded-xl lg:rounded-[26px] shadow-[0px_25px_68px_0px_rgba(0,0,0,0.05)] outline outline-[0.50px] outline-offset-[-0.50px] outline-white overflow-hidden">
					...
					<div class="absolute inset-0 bg-white/20 blur-[4px] rounded-2xl lg:rounded-[26px]"></div>
					<!-- Video element -->
  ...
  <div class="w-full mt-[80px] sm:mt-12 lg:mt-[56px] flex flex-col justify-center items-center gap-16 sm:gap-20 lg:gap-xl-112 px-4 sm:px-8 lg:px-16 xl:px-24">
    ...
    <section class="self-stretch flex flex-col justify-start items-center gap-8 lg:gap-lg-16">
      ...
      <div class="w-full lg:self-stretch flex flex-col lg:flex-row lg:h-64 justify-center lg:justify-start items-center lg:items-center gap-4">
        <!-- Body Signal Tracker -->
        <div class="w-full h-[168px] lg:flex-1 lg:h-auto lg:self-stretch p-4 bg-teal-600/5 rounded-2xl flex flex-col justify-between items-start overflow-hidden">
    ...
    <section class="self-stretch flex flex-col justify-start items-center gap-4 lg:gap-6">
      ...
      <!-- Responsive container that switches from vertical (mobile) to horizontal (desktop) -->
      <div class="w-full lg:w-[1247px] flex flex-col lg:flex-row justify-center lg:justify-start items-center lg:items-center gap-8 lg:gap-2">
    ...
    <!-- Final CTA Section -->
    <section class="flex flex-col justify-start items-center gap-8 lg:gap-12 mb-[45px] lg:mb-[53px]">
