...
<div class="w-full h-auto relative bg-pure-white overflow-hidden">
	...
	<div class="w-full flex justify-center items-center py-8">
		<div class="w-full max-w-6xl mx-auto px-4">
			...
			<div class="self-stretch inline-flex flex-col justify-start items-center gap-10">
				<!-- Page Title -->
				<div class="w-full max-w-[1036px] flex flex-col justify-start items-center gap-4">
					<div class="self-stretch text-center justify-start text-black text-4xl font-bold font-['Nunito_Sans'] leading-10">Blogs</div>
				</div>
				
				<!-- Blog Content -->
				<div class="self-stretch flex flex-col justify-start items-start gap-20">
					<div class="self-stretch flex flex-col justify-center items-start gap-10">
						
						<!-- Title with Back Button -->
						<div class="self-stretch inline-flex justify-start items-center gap-4">
							<button 
								on:click={goBack}
								class="w-8 h-8 relative overflow-hidden hover:bg-gray-100 rounded-full flex items-center justify-center transition-colors"
							...
							<div class="justify-start text-black text-3xl font-bold font-['Nunito_Sans'] leading-10 flex-1">
								{blogPost.title}
							</div>
						</div>
						...
						<!-- Featured Image -->
						<img 
							class="self-stretch h-96 relative rounded-lg object-cover" 
						...
						<div class="self-stretch flex flex-col justify-start items-end gap-6">
							<div class="self-stretch flex flex-col justify-start items-start gap-4">
								...
								<!-- Main Content -->
								<div class="self-stretch justify-start text-black text-base font-normal font-['Nunito_Sans'] leading-normal">
									{@html blogPost.content.replace(/\n\n/g, '<br/><br/>')}
								</div>
								
								<!-- Subtitle -->
								<div class="self-stretch justify-start text-black text-2xl font-bold font-['Nunito_Sans'] leading-10">
									{blogPost.subtitle}
								</div>
								
								<!-- Additional Content -->
								<div class="self-stretch justify-start text-black text-base font-normal font-['Nunito_Sans'] leading-normal">
									{@html blogPost.additionalContent.replace(/\n\n/g, '<br/><br/>')}
								</div>
								
								<!-- Inline Image -->
								<img 
									class="self-stretch h-96 relative rounded-lg object-cover" 
									src={blogPost.inlineImage} 
							...
							<div class="self-stretch inline-flex justify-end items-start gap-4">
								<div class="justify-start text-black text-base font-normal font-['Nunito_Sans'] leading-normal">Share</div>
	...
	<div class="w-full flex justify-center items-center py-16">
		<div class="w-full max-w-6xl mx-auto px-4">
			<div class="self-stretch inline-flex flex-col justify-start items-start gap-8">
				<div class="self-stretch justify-start text-black text-4xl font-bold font-['Nunito_Sans'] leading-10">Keep reading</div>
				<div class="self-stretch flex flex-col justify-start items-start gap-20">
					{#each otherBlogPosts as post}
						<a href="/blog/{post.slug}" class="self-stretch inline-flex justify-start items-center gap-10 cursor-pointer hover:opacity-90 transition-opacity">
							<img class="w-[500px] h-[416px] relative rounded-lg object-cover" src={post.featuredImage} alt={post.title} />
							<div class="w-[660px] inline-flex flex-col justify-start items-end gap-6">
								<div class="self-stretch flex flex-col justify-start items-start gap-4">
									<div class="w-[637px] justify-start text-black text-3xl font-bold font-['Nunito_Sans'] leading-10">{post.title}</div>
									<div class="self-stretch justify-start text-black text-base font-normal font-['Nunito_Sans'] leading-normal">{@html post.content.replace(/\n\n/g, '<br/><br/>')}</div>
								</div>
								<div class="self-stretch inline-flex justify-end items-start gap-4">
									<div class="justify-start text-black text-base font-normal font-['Nunito_Sans'] leading-normal">Share</div>
									<div class="flex justify-start items-center gap-3.5">
